...
function Park_opp_snake_parkTable_LeastConcern() {
    ...
    useEffect(()=>{
      axios.get("https://afternoon-mountain-93761.herokuapp.com/conservationstatus/Park_opp_snake_parkLeastConcern").then(res=> {
        ...
        setPark_opp_snake_parkLeastConcern(res.data)
    })
      },[])
        ...
        <div>
            <TableContainer component={Paper}>
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        {
                            Park_opp_snake_parkLeastConcern.map((item) =>{
                                return (
                                    <TableRow>
...
export default Park_opp_snake_parkTable_LeastConcern
