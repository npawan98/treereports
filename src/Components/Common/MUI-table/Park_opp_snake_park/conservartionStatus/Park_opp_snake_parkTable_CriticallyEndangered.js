...
function Park_opp_snake_parkTable_CriticallyEndangered() {
        ...
        <div>
            <TableContainer component={Paper}>
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        {
                            Park_opp_snake_parkCriticallyEndangered.map((item) =>{
                                return (
                                    <TableRow>
...
export default Park_opp_snake_parkTable_CriticallyEndangered
