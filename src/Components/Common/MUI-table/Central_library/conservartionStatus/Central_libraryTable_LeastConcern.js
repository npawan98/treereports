...
function Central_libraryTable_LeastConcern() {
    ...
    useEffect(()=>{
      axios.get("https://afternoon-mountain-93761.herokuapp.com/conservationstatus/Central_libraryLeastConcern").then(res=> {
        ...
        setCentral_libraryLeastConcern(res.data)
    })
      },[])
        ...
        <div>
            <TableContainer component={Paper}>
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        {
                            Central_libraryLeastConcern.map((item) =>{
                                return (
                                    <TableRow>
...
export default Central_libraryTable_LeastConcern
