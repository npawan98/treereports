...
function Central_libraryTable_CriticallyEndangered() {
        ...
        <div>
            <TableContainer component={Paper}>
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        {
                            Central_libraryCriticallyEndangered.map((item) =>{
                                return (
                                    <TableRow>
...
export default Central_libraryTable_CriticallyEndangered
