...
function Park_opp_workers_clubTable_LeastConcern() {
    ...
    useEffect(()=>{
      axios.get("https://afternoon-mountain-93761.herokuapp.com/conservationstatus/Park_opp_workers_clubLeastConcern").then(res=> {
        ...
        setPark_opp_workers_clubLeastConcern(res.data)
    })
      },[])
        ...
        <div>
            <TableContainer component={Paper}>
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        {
                            Park_opp_workers_clubLeastConcern.map((item) =>{
                                return (
                                    <TableRow>
...
export default Park_opp_workers_clubTable_LeastConcern
