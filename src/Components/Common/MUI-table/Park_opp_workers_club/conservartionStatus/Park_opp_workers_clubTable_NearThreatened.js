...
function Park_opp_workers_clubTable_NearThreatened() {
        ...
        <div>
            <TableContainer component={Paper}>
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        {
                            Park_opp_workers_clubNearThreatened.map((item) =>{
                                return (
                                    <TableRow>
...
export default Park_opp_workers_clubTable_NearThreatened
