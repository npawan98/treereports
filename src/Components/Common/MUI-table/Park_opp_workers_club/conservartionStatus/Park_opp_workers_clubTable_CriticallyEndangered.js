...
function Park_opp_workers_clubTable_CriticallyEndangered() {
        ...
        <div>
            <TableContainer component={Paper}>
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        {
                            Park_opp_workers_clubCriticallyEndangered.map((item) =>{
                                return (
                                    <TableRow>
...
export default Park_opp_workers_clubTable_CriticallyEndangered
