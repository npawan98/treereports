...
function Kslta_hort_deptTable_ConservationDependent() {
        ...
        <div>
            <TableContainer component={Paper}>
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        {
                            Kslta_hort_deptConservationDependent.map((item) =>{
                                return (
                                    <TableRow>
...
export default Kslta_hort_deptTable_ConservationDependent
