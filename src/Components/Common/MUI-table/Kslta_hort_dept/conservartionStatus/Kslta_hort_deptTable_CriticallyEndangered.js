...
function Kslta_hort_deptTable_CriticallyEndangered() {
        ...
        <div>
            <TableContainer component={Paper}>
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        {
                            Kslta_hort_deptCriticallyEndangered.map((item) =>{
                                return (
                                    <TableRow>
...
export default Kslta_hort_deptTable_CriticallyEndangered
