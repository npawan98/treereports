...
function Park_opp_wine_boardTable_CriticallyEndangered() {
        ...
        <div>
            <TableContainer component={Paper}>
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        {
                            Park_opp_wine_boardCriticallyEndangered.map((item) =>{
                                return (
                                    <TableRow>
...
export default Park_opp_wine_boardTable_CriticallyEndangered
