...
function Park_opp_wine_boardTable_LeastConcern() {
    ...
    useEffect(()=>{
      axios.get("https://afternoon-mountain-93761.herokuapp.com/conservationstatus/Park_opp_wine_boardLeastConcern").then(res=> {
        ...
        setPark_opp_wine_boardLeastConcern(res.data)
    })
      },[])
        ...
        <div>
            <TableContainer component={Paper}>
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        {
                            Park_opp_wine_boardLeastConcern.map((item) =>{
                                return (
                                    <TableRow>
...
export default Park_opp_wine_boardTable_LeastConcern
