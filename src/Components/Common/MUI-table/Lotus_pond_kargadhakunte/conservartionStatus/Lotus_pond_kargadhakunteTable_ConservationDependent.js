...
function Lotus_pond_kargadhakunteTable_ConservationDependent() {
        ...
        <div>
            <TableContainer component={Paper}>
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        {
                            Lotus_pond_kargadhakunteConservationDependent.map((item) =>{
                                return (
                                    <TableRow>
...
export default Lotus_pond_kargadhakunteTable_ConservationDependent
