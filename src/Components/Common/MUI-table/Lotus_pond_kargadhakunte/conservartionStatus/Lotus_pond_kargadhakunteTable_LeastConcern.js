...
function Lotus_pond_kargadhakunteTable_LeastConcern() {
    ...
    useEffect(()=>{
      axios.get("https://afternoon-mountain-93761.herokuapp.com/conservationstatus/Lotus_pond_kargadhakunteLeastConcern").then(res=> {
        ...
        setLotus_pond_kargadhakunteLeastConcern(res.data)
    })
      },[])
        ...
        <div>
            <TableContainer component={Paper}>
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        {
                            Lotus_pond_kargadhakunteLeastConcern.map((item) =>{
                                return (
                                    <TableRow>
...
export default Lotus_pond_kargadhakunteTable_LeastConcern
