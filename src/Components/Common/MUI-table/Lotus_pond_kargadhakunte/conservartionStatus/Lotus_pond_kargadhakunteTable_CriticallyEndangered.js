...
function Lotus_pond_kargadhakunteTable_CriticallyEndangered() {
        ...
        <div>
            <TableContainer component={Paper}>
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        {
                            Lotus_pond_kargadhakunteCriticallyEndangered.map((item) =>{
                                return (
                                    <TableRow>
...
export default Lotus_pond_kargadhakunteTable_CriticallyEndangered
